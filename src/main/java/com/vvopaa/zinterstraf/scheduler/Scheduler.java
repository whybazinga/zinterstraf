...
public class Scheduler {
  ...
  private final ProScheduleService proScheduleService;

  @Autowired
  public Scheduler(ProTeamService proTeamService, ProPlayerService proPlayerService, ProScheduleService proScheduleService) {
