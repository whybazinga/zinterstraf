...
function buttonManager(e) {
    var elementVal = getElementValue(e.target);
...
function ajaxLogin(e) {
    var emailVal = getElementValue(ENTRY_ELEMENTS.inputEmail);
    var passVal = getElementValue(ENTRY_ELEMENTS.inputPass);
...
function ajaxRegister(e) {
    var emailVal = getElementValue(ENTRY_ELEMENTS.inputEmail);
    var passVal = getElementValue(ENTRY_ELEMENTS.inputPass);
    var passConfVal = getElementValue(ENTRY_ELEMENTS.inputPassConf);
